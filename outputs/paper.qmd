...
cleaned_data <- read.csv("cleaned_data")
...
@fig-2, @fig-3 indicate that negative binomial approach is a better choice for this circumstance. But it’s too early to draw conclusions from the figures alone.
```{r echo = FALSE}
#| label: fig-2
#| warning: false
#| fig-cap: "(a) Poisson model"
...
#| label: fig-3
#| warning: false
#| fig-cap: "(b) Negative binomial model"
